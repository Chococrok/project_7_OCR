...
public class UserAction extends LibraryActionSupport implements SessionAware {
	...
	public String execute() throws Exception {
		...
		List<Reservation> reservations = this.reservationService.findAllReservationByAccount(account.getId());
		this.reservationPOJOs = this.reservationService.modelsToPojos(reservations);
		this.page = "user";
		return SUCCESS;
	}
